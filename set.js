...
OWNER_NUMBER: process.env.OWNER_NUMBER || "18632280160", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝐀𝐋𝐋𝐈𝐒𝐎𝐍", // Input Yours custom...(Maintain font for Flow)
